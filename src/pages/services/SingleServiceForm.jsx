  ...
  return (
    <div className="mt-8 p-2">
      ...
      <div className="my-4 p-4 ml-[1rem]   w-[67%]  bg-white rounded">
        ...
        <hr />
        <div className="my-4">
          <h5 className="text-sm my-2">Service type</h5>
          <span className="text-md my-2">Hair Color</span>
        </div>
        <div className="my-4">
          <h5 className="text-sm my-2">Service type</h5>
          <span className="text-md my-2">Simple</span>
        </div>
        <div className="my-8">
          <TextField
            className="w-full"
...
export default SingleServicesForm;
